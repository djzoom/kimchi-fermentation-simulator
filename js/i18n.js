...
window.KimchiSim.i18n = (function () {
  ...
  var strings = {
    ...
    'calc.salt': { en: 'Salt (curing)', ko: '소금 (절임용)', zh: '盐（腌制）', de: 'Salz (P\u00f6keln)' },
    'calc.brine.water': { en: 'Curing water', ko: '절임 물', zh: '腌制水', de: 'P\u00f6kelwasser' },
    'calc.coarse.salt': { en: 'Coarse Salt', ko: '굵은소금', zh: '粗盐', de: 'Grobes Salz' },
    'calc.chili': { en: 'Chili Powder', ko: '고춧가루', zh: '辣椒粉', de: 'Chilipulver' },
    'calc.chili.coarse': { en: 'Coarse chili flakes', ko: '굵은 고춧가루', zh: '粗辣椒面', de: 'Grobe Chiliflocken' },
    'calc.chili.fine': { en: 'Fine chili powder', ko: '고운 고춧가루', zh: '细辣椒面', de: 'Feines Chilipulver' },
    ...
    'calc.rice.flour': { en: 'Sweet rice flour', ko: '찹쌀가루', zh: '糯米粉', de: 'Klebreismehl' },
    'calc.rice.water': { en: 'Paste water', ko: '풀용 물', zh: '糯米糊水', de: 'Wasser f\u00fcr Paste' },
    'calc.scallion': { en: 'Green Onion', ko: '쪽파', zh: '小葱', de: 'Fr\u00fchlingszwiebel' },
    'calc.apple': { en: 'Apple', ko: '사과', zh: '苹果', de: 'Apfel' },
    'calc.pear': { en: 'Pear', ko: '배', zh: '梨', de: 'Birne' },
    'calc.sugar': { en: 'Sugar', ko: '설탕', zh: '白糖', de: 'Zucker' },
    'calc.msg': { en: 'MSG', ko: 'MSG (조미료)', zh: '味精', de: 'Mononatriumglutamat' },
    'calc.optional.label': { en: 'Optional · flavor enhancers', ko: '선택 · 풍미 강화', zh: '备选 · 提升风味', de: 'Optional \u00b7 Geschmacksverst\u00e4rker' },
    'calc.note': { en: 'Base recipe — add optional items to taste.', ko: '기본 레시피 — 선택 재료는 취향껏 추가.', zh: '基本配方 — 备选配料可酌情添加。', de: 'Grundrezept \u2014 optionale Zutaten nach Geschmack hinzuf\u00fcgen.' },
